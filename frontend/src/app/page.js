  ...
  return (
    <div className={`min-h-screen w-full transition-colors duration-300 ${
      ...
      <main className="pt-14 pb-2 px-4 lg:px-6 max-w-7xl mx-auto flex flex-col h-[calc(100vh-56px)] overflow-hidden">
        ...
        {/* ── 비균형 3열 그리드 (5 : 4 : 2 = 11) ── */}
        <div className="grid grid-cols-1 lg:grid-cols-11 gap-3 flex-1 min-h-0 items-start overflow-hidden">

          {/* ┌── 왼쪽 (2칸) — 코스닥 + 투자성향 & 포트폴리오 선택 ──┐ */}
          <div className="lg:col-span-2 flex flex-col gap-3 h-full overflow-auto">
          ...
          {/* ┌── 중간 (4칸) — 종목별 날씨 ──┐ */}
          <div className="lg:col-span-4 flex flex-col gap-3 h-full overflow-auto">
            <StockWeatherList stocks={stockWeatherList} isDark={isDark} />
          </div>

          {/* ┌── 오른쪽 (5칸) — 보유 자산 도넛 ──┐ */}
          <div className="lg:col-span-5 flex flex-col gap-3 h-full overflow-auto">
            <AssetSummaryCard
