...
export default function Icon({ name, className = "w-5 h-5", ...props }) {
  const icons = {
    ...
    sparkles: (
      <>
        <path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.3-6.3l-.7.7M6.7 17.3l-.7.7m12.6 0l-.7-.7M6.7 5.3l-.7-.7" />
    ...
    scale: (
      <>
        <path d="m16 16 3-8 3 8c-.87.62-1.9 1-3 1s-2.13-.38-3-1z" />
        <path d="m2 16 3-8 3 8c-.87.62-1.9 1-3 1s-2.13-.38-3-1z" />
