...
export const QUESTIONS = [
  ...
  {
    id: 2,
    phase: "PHASE 02: RISK WILLINGNESS",
    category: "투자 목표",
...
export const RESULT_PROFILES = {
  CONSERVATIVE: {
    ...
    titleKo: '안정형',
    titleEn: 'Conservative Investor',
    precisionScore: 12.5,
    expectedReturn: '+3.2%',
    description: "원본 자금의 완벽한 보존을 최우선 목표로 삼는 보수적 투자 성향입니다. 인플레이션 방어 수준의 이자와 안정적 채권 흐름을 결합하여 가치를 유지하는 데 집중합니다.",
    drawdownThreshold: '-3.0%',
    speculativeOverlay: '0.0%',
    riskCapacityPct: 15,
    liquidity: 'SURPLUS',
    horizon: '1-2 YRS',
    tradingFrequency: '1-2 TRADES / YEAR',
    avgHoldTime: '360 DAYS',
    leverageUse: 'NONE',
    assetClassFocus: ['CASH', 'MUNICIPAL BONDS'],
  ...
  MODERATE_CONSERVATIVE: {
    ...
    titleKo: '안정추구형',
    titleEn: 'Moderate Conservative',
    precisionScore: 35.8,
    expectedReturn: '+5.8%',
    description: "원금 손실 가능성은 기피하되, 정기 예금보다는 약간 높은 이익 성장을 유도하려는 투자 성향입니다. 채권 혼합형 모델을 활용해 리스크가 온화하게 희석되도록 제어합니다.",
    drawdownThreshold: '-8.0%',
    speculativeOverlay: '2.5%',
    riskCapacityPct: 38,
    liquidity: 'STABLE',
    horizon: '2-3 YRS',
    tradingFrequency: '12 TRADES / YEAR',
    avgHoldTime: '120 DAYS',
    leverageUse: 'NONE',
    assetClassFocus: ['GOVT BONDS', 'DIVIDEND EQUITIES'],
  ...
  BALANCED: {
    ...
    liquidity: 'STABLE',
    horizon: '3-5 YRS',
    tradingFrequency: '24 TRADES / YEAR',
    avgHoldTime: '45 DAYS',
    leverageUse: 'LOW',
    assetClassFocus: ['GLOBAL ETF', 'BALANCED FUNDS'],
  ...
  GROWTH: {
    category: 'GROWTH',
    titleKo: '적극투자형',
    titleEn: 'Growth-Seeking Investor',
    precisionScore: 88.42,
    expectedReturn: '+12.4%',
    description: "변동성을 투자의 필연적인 파트너로 여기며 높은 리스크를 감수하는 성장 투자 성향입니다. 글로벌 하이테크 성장주와 암호화폐 영역까지 적극적으로 스코프를 확장합니다.",
    drawdownThreshold: '-25.0%',
    speculativeOverlay: '15.0%',
    riskCapacityPct: 82,
    liquidity: 'SURPLUS',
    horizon: '10+ YRS',
    tradingFrequency: '42 TRADES / YEAR',
    avgHoldTime: '14 DAYS',
    leverageUse: 'MODERATE',
    assetClassFocus: ['EQUITIES', 'CRYPTO'],
    marketResponse: "변동성을 감내하며 장기적 우상향과 기회 포착을 극대화합니다.",
    assetAllocationDesc: "글로벌 혁신 기업 및 디지털 자산 비중이 75% 이상 편입된 공격형 배분입니다.",
    keywords: "섹터 로테이션, 성장 촉진, 레버리지, 복리 복제",
    dimensions: {
  ...
  AGGRESSIVE: {
    category: 'AGGRESSIVE',
    titleKo: '공격투자형',
    titleEn: 'Aggressive Explorer',
    precisionScore: 98.15,
    expectedReturn: '+18.7%',
    description: "한계 리스크가 거의 존재하지 않는 최고조 공격 성향입니다. 자산 가치의 극심한 단기 폭락(최대 50% 이상)의 가능성을 원천 차단하지 않고, 오직 자본의 기하급수 승수 성취에 올인합니다.",
    drawdownThreshold: '-45.0%',
    speculativeOverlay: '35.0%',
    riskCapacityPct: 95,
    liquidity: 'SURPLUS',
    horizon: '10+ YRS',
    tradingFrequency: '120 TRADES / YEAR',
    avgHoldTime: '3 DAYS',
    leverageUse: 'HIGH',
    assetClassFocus: ['HIGH-BETA TECH', 'DERIVATIVES', 'ALT-COINS'],
    marketResponse: "조정 하락 국면을 대규모 저가 매수 및 역베팅 기회로 간주하며 즐깁니다.",
    assetAllocationDesc: "현금 및 안전자산을 배제하고 순수 초성장주, 암호화폐, 레버리지 파생상품 위주 운용입니다.",
